...
// 	stepper = WIMG - 1;
// 	reset_coord(line_data.entity);
// 	line_data.pixel_p[X] = (data->player.entity.map[X] * WIMG) + PLAYER_OFFSET;
// 	line_data.pixel_p[Y] = (data->player.entity.map[Y] * HIMG) + PLAYER_OFFSET;
...
// 			break ;
// 		add_coord(line_data.entity, line_data.int_x, line_data.int_y);
...
// 		return (true);
// 	}
// 	print_coord(data, line_data->entity);
// 	reset_coord(line_data->entity);
// 	return (false);
// }
...
// 	line_data->final_x = x;
// 	line_data->final_y = y;
// 	line_data->int_x = (data->player.entity.map[X] * WIMG) + (WIMG / 2);
// 	line_data->int_y = (data->player.entity.map[Y] * HIMG) + (HIMG / 2);
// 	line_data->curr_x = (int)(data->player.entity.map[X] * WIMG) + (WIMG / 2);
// 	line_data->curr_y = (int)(data->player.entity.map[Y] * HIMG) + (HIMG / 2);
// 	line_data->x_sign = POSITIVE;
// 	line_data->y_sign = POSITIVE;
// 	if ((data->player.entity.map[X] * WIMG) + WIMG / 2 > x)
// 		line_data->x_sign = NEGATIVE;
// 	if ((data->player.entity.map[Y] * HIMG) + HIMG / 2 > y)
...
// 	line_data->delta_x = x - ((data->player.entity.map[X] * WIMG) + (WIMG / 2));
// 	line_data->delta_y = y - ((data->player.entity.map[Y] * HIMG) + (HIMG / 2));
