...
/*   Updated: 2025/07/18 12:51:13 by alerusso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player(t_data *data)
{
	...
	if (data->player.line.type == 'E')
		data->player.line.pov[X] = DEG_0;
	else if (data->player.line.type == 'N')
		data->player.line.pov[X] = DEG_90;
	else if (data->player.line.type == 'W')
		data->player.line.pov[X] = DEG_180;
	else if (data->player.line.type == 'S')
		data->player.line.pov[X] = DEG_270;
}
