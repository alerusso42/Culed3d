...
/*   Updated: 2025/09/01 10:29:15 by lparolis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// t_txtr	*texture_finder(t_data *data, double ray_angle,\
int hit_x, int hit_y);
// void	init_line_data(t_data *data, t_entity\
*entity_data, double pov_x);
...
// int		the_wall_checker(t_entity *entity,\
t_data *data, double angle, int i);
...
// int		texture_x_offset(t_data *data,\
 double ray_angle, int hit_x, int hit_y);
